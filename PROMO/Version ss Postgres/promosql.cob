...
OCESQL*
OCESQL 01  SQ0002.
OCESQL     02  FILLER PIC X(213) VALUE "SELECT st.ST_ID, co.CO_ID, st."
OCESQL  &  "ST_LASTNAME, st.ST_FIRSTNAME, co.CO_LABEL, co.CO_COEF, gr."
OCESQL  &  "GR_GRADE FROM STUDENT st, GRADE gr, COURSE co WHERE (st.ST"
OCESQL  &  "_ID = gr.ST_ID AND co.CO_ID = gr.CO_ID) ORDER BY st.ST_ID,"
OCESQL  &  " co.CO_ID".
OCESQL     02  FILLER PIC X(1) VALUE X"00".
OCESQL*
OCESQL 01  SQ0003.
OCESQL     02  FILLER PIC X(095) VALUE "SELECT gr.CO_ID, SUM(gr.GR_GRA"
OCESQL  &  "DE * gr.GR_COEF), SUM(gr.GR_COEF) FROM GRADE gr GROUP BY g"
OCESQL  &  "r.CO_ID".
OCESQL     02  FILLER PIC X(1) VALUE X"00".
OCESQL*
OCESQL 01  SQ0004.
OCESQL     02  FILLER PIC X(187) VALUE "SELECT gr.ST_ID, co.CO_ID, (SU"
OCESQL  &  "M(gr.GR_GRADE * gr.GR_COEF)) * co.CO_COEF, SUM(gr.GR_COEF "
OCESQL  &  "* co.CO_COEF) FROM GRADE gr INNER JOIN COURSE co ON gr.CO_"
OCESQL  &  "ID = co.CO_ID GROUP BY gr.ST_ID, co.CO_ID".
OCESQL     02  FILLER PIC X(1) VALUE X"00".
OCESQL*
OCESQL 01  SQ0005.
OCESQL     02  FILLER PIC X(030) VALUE "SELECT COUNT( * ) FROM STUDENT".
OCESQL     02  FILLER PIC X(1) VALUE X"00".
OCESQL*
OCESQL 01  SQ0006.
OCESQL     02  FILLER PIC X(029) VALUE "SELECT COUNT( * ) FROM COURSE".
OCESQL     02  FILLER PIC X(1) VALUE X"00".
OCESQL*
OCESQL 01  SQ0007.
OCESQL     02  FILLER PIC X(028) VALUE "SELECT COUNT( * ) FROM GRADE".
OCESQL     02  FILLER PIC X(1) VALUE X"00".
OCESQL*
       PROCEDURE DIVISION.
      *0000-Main-start
...
OCESQL     END-CALL.
      ...
      *                , gr.GR_COEF
OCESQL*    EXEC SQL 
OCESQL*       DECLARE CURSEUR1 CURSOR FOR
OCESQL*          SELECT st.ST_ID, co.CO_ID, st.ST_LASTNAME, 
OCESQL*                st.ST_FIRSTNAME, co.CO_LABEL, co.CO_COEF,
OCESQL*                gr.GR_GRADE
OCESQL*                gr.GR_GRADE
OCESQL*          FROM STUDENT st , GRADE gr , COURSE co 
OCESQL*          WHERE (st.ST_ID = gr.ST_ID AND co.CO_ID = gr.CO_ID)
OCESQL*          ORDER BY st.ST_ID,co.CO_ID     
OCESQL*    END-EXEC.
OCESQL     CALL "OCESQLCursorDeclare" USING
OCESQL          BY REFERENCE SQLCA
OCESQL          BY REFERENCE "promosql_CURSEUR1" & x"00"
...
OCESQL    .
      ...
      *       ,:SQL-CUR1-GR-COEF
OCESQL*    EXEC SQL 
OCESQL*       FETCH CURSEUR1 
OCESQL*       INTO :SQL-CUR1-ST-ID, :SQL-CUR1-CO-ID, 
OCESQL*       :SQL-CUR1-ST-LASTNAME, :SQL-CUR1-ST-FIRSTNAME,
OCESQL*       :SQL-CUR1-CO-LABEL, :SQL-CUR1-CO-COEF,
OCESQL*       :SQL-CUR1-GR-GRADE
OCESQL*       :SQL-CUR1-GR-GRADE
OCESQL*    END-EXEC.
...
OCESQL          BY VALUE 2
OCESQL          BY VALUE 0
OCESQL          BY REFERENCE SQL-CUR1-ST-ID
OCESQL     END-CALL
OCESQL     CALL "OCESQLSetResultParams" USING
OCESQL          BY VALUE 1
OCESQL          BY VALUE 2
OCESQL          BY VALUE 0
OCESQL          BY REFERENCE SQL-CUR1-CO-ID
OCESQL     END-CALL
OCESQL     CALL "OCESQLSetResultParams" USING
OCESQL          BY VALUE 16
OCESQL          BY VALUE 7
OCESQL          BY VALUE 0
OCESQL          BY REFERENCE SQL-CUR1-ST-LASTNAME
OCESQL     END-CALL
OCESQL     CALL "OCESQLSetResultParams" USING
OCESQL          BY VALUE 16
OCESQL          BY VALUE 6
OCESQL          BY VALUE 0
OCESQL          BY REFERENCE SQL-CUR1-ST-FIRSTNAME
OCESQL     END-CALL
OCESQL     CALL "OCESQLSetResultParams" USING
OCESQL          BY VALUE 16
OCESQL          BY VALUE 21
OCESQL          BY VALUE 0
OCESQL          BY REFERENCE SQL-CUR1-CO-LABEL
OCESQL     END-CALL
OCESQL     CALL "OCESQLSetResultParams" USING
OCESQL          BY VALUE 1
OCESQL          BY VALUE 2
OCESQL          BY VALUE -1
OCESQL          BY REFERENCE SQL-CUR1-CO-COEF
OCESQL     END-CALL
OCESQL     CALL "OCESQLSetResultParams" USING
OCESQL          BY VALUE 1
OCESQL          BY VALUE 4
OCESQL          BY VALUE -2
OCESQL          BY REFERENCE SQL-CUR1-GR-GRADE
OCESQL     END-CALL
...
OCESQL     END-CALL
       ...
       3040-CURSEUR2-START.
OCESQL*    EXEC SQL 
OCESQL*       DECLARE CURSEUR2 CURSOR FOR
OCESQL*          SELECT gr.CO_ID, 
OCESQL*             SUM(gr.GR_GRADE * gr.GR_COEF),
OCESQL*             SUM(gr.GR_COEF)
OCESQL*       FROM GRADE gr 
OCESQL*       GROUP BY gr.CO_ID
OCESQL*    END-EXEC.
OCESQL     CALL "OCESQLCursorDeclare" USING
OCESQL          BY REFERENCE SQLCA
OCESQL          BY REFERENCE "promosql_CURSEUR2" & x"00"
...
OCESQL*    EXEC SQL 
OCESQL*       FETCH CURSEUR2 
OCESQL*       INTO  :SQL-CUR2-CO-ID, :SQL-CUR2-DIVIDEND, 
OCESQL*             :SQL-CUR2-DIVISEUR
OCESQL*    END-EXEC.
OCESQL     CALL "OCESQLStartSQL"
OCESQL     END-CALL
OCESQL     CALL "OCESQLSetResultParams" USING
...
OCESQL          BY VALUE 2
OCESQL          BY VALUE 0
OCESQL          BY REFERENCE SQL-CUR2-CO-ID
OCESQL     END-CALL
OCESQL     CALL "OCESQLSetResultParams" USING
OCESQL          BY VALUE 1
OCESQL          BY VALUE 5
OCESQL          BY VALUE -2
OCESQL          BY REFERENCE SQL-CUR2-DIVIDEND
OCESQL     END-CALL
OCESQL     CALL "OCESQLSetResultParams" USING
OCESQL          BY VALUE 1
OCESQL          BY VALUE 3
OCESQL          BY VALUE -1
OCESQL          BY REFERENCE SQL-CUR2-DIVISEUR
OCESQL     END-CALL
OCESQL     CALL "OCESQLCursorFetchOne" USING
OCESQL          BY REFERENCE SQLCA
OCESQL          BY REFERENCE "promosql_CURSEUR2" & x"00"
...
OCESQL     END-CALL
       ...
       3060-CURSEUR3-START.
OCESQL*    EXEC SQL 
OCESQL*       DECLARE CURSEUR3 CURSOR FOR
OCESQL*          SELECT gr.ST_ID , co.CO_ID, 
OCESQL*             (SUM(gr.GR_GRADE * gr.GR_COEF)) * co.CO_COEF,
OCESQL*             SUM(gr.GR_COEF * co.CO_COEF)
OCESQL*       FROM GRADE gr INNER JOIN COURSE co
OCESQL*       ON gr.CO_ID = co.CO_ID
OCESQL*       GROUP BY gr.ST_ID, co.CO_ID
OCESQL*    END-EXEC.
OCESQL     CALL "OCESQLCursorDeclare" USING
OCESQL          BY REFERENCE SQLCA
OCESQL          BY REFERENCE "promosql_CURSEUR3" & x"00"
...
OCESQL*    EXEC SQL 
OCESQL*       FETCH CURSEUR3 
OCESQL*       INTO  :SQL-CUR3-ST-ID, :SQL-CUR3-CO-ID,:SQL-CUR3-DIVIDEND, 
OCESQL*             :SQL-CUR3-DIVISEUR
OCESQL*    END-EXEC.
OCESQL     CALL "OCESQLStartSQL"
OCESQL     END-CALL
OCESQL     CALL "OCESQLSetResultParams" USING
...
OCESQL          BY VALUE 2
OCESQL          BY VALUE 0
OCESQL          BY REFERENCE SQL-CUR3-ST-ID
OCESQL     END-CALL
OCESQL     CALL "OCESQLSetResultParams" USING
OCESQL          BY VALUE 1
OCESQL          BY VALUE 2
OCESQL          BY VALUE 0
OCESQL          BY REFERENCE SQL-CUR3-CO-ID
OCESQL     END-CALL
OCESQL     CALL "OCESQLSetResultParams" USING
OCESQL          BY VALUE 1
OCESQL          BY VALUE 5
OCESQL          BY VALUE -2
OCESQL          BY REFERENCE SQL-CUR3-DIVIDEND
OCESQL     END-CALL
OCESQL     CALL "OCESQLSetResultParams" USING
OCESQL          BY VALUE 1
OCESQL          BY VALUE 3
OCESQL          BY VALUE -1
OCESQL          BY REFERENCE SQL-CUR3-DIVISEUR
OCESQL     END-CALL
OCESQL     CALL "OCESQLCursorFetchOne" USING
OCESQL          BY REFERENCE SQLCA
OCESQL          BY REFERENCE "promosql_CURSEUR3" & x"00"
...
OCESQL*       EXEC SQL 
OCESQL*          FETCH CURSEUR3
OCESQL*          INTO :SQL-CUR3-ST-ID, :SQL-CUR3-CO-ID, 
OCESQL*          :SQL-CUR3-DIVIDEND, :SQL-CUR3-DIVISEUR
OCESQL*       END-EXEC
OCESQL     CALL "OCESQLStartSQL"
OCESQL     END-CALL
OCESQL     CALL "OCESQLSetResultParams" USING
...
OCESQL*    EXEC SQL 
OCESQL*       SELECT COUNT(*) INTO :SQL_NB_STUDENT FROM STUDENT;
OCESQL*    END-EXEC. 
OCESQL     CALL "OCESQLStartSQL"
OCESQL     END-CALL
OCESQL     CALL "OCESQLSetResultParams" USING
...
OCESQL          BY VALUE 2
OCESQL          BY VALUE 0
OCESQL          BY REFERENCE SQL_NB_STUDENT
OCESQL     END-CALL
...
OCESQL*    EXEC SQL 
OCESQL*       SELECT COUNT(*) INTO :SQL_NB_COURS FROM COURSE;
OCESQL*    END-EXEC. 
OCESQL     CALL "OCESQLStartSQL"
OCESQL     END-CALL
OCESQL     CALL "OCESQLSetResultParams" USING
...
OCESQL          BY VALUE 2
OCESQL          BY VALUE 0
OCESQL          BY REFERENCE SQL_NB_COURS
OCESQL     END-CALL
OCESQL     CALL "OCESQLExecSelectIntoOne" USING
OCESQL          BY REFERENCE SQLCA
...
OCESQL*    EXEC SQL 
OCESQL*       SELECT COUNT(*) INTO :SQL_NB_ENREG FROM GRADE;
OCESQL*    END-EXEC. 
OCESQL     CALL "OCESQLStartSQL"
OCESQL     END-CALL
OCESQL     CALL "OCESQLSetResultParams" USING
...
OCESQL          BY VALUE 2
OCESQL          BY VALUE 0
OCESQL          BY REFERENCE SQL_NB_ENREG
OCESQL     END-CALL
OCESQL     CALL "OCESQLExecSelectIntoOne" USING
OCESQL          BY REFERENCE SQLCA
