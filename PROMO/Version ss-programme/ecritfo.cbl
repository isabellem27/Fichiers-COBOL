      ...
      * LEGENDE DU DOCUMENT
       ...
       01  WS-COURS .
           ...
           03  WS-COURS-TAB  OCCURS 1 TO 99 
              ...
              05 WS-COURS-MOY      PIC 9(3)V99    .
              05 WS-COURS-DIV      PIC 99         .
      ...
      *    J'ajoute mes moyennes par cours
       ...
       7056-WRITE-LEG-START.
           ...
           PERFORM 7058-WRITE-CADRE-LEG-START THRU
                    7059-WRITE-CADRE-LEG-END .
       ...
       7058-WRITE-CADRE-LEG-START.
           MOVE ALL SPACE TO REC-F-OUTPUT   .
           MOVE ALL '-' TO WS-LIG-26        .
           STRING
                   WS-LIG-BLANC20
                   SPACE 
                   WS-LIG-ETOILE 
